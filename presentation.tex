...
\begin{frame}{Configuraciones estudiadas}
  \begin{center}
    \begin{tabular}{@{}llll@{}}
      ...
      Pared             & pared de círculos    & Algoritmo genético (GA) & grano, perfil \\
      \bottomrule
    \end{tabular}
  \end{center}
\end{frame}

\begin{frame}{Configuraciones sin GA}
  \begin{columns}[T,onlytextwidth]
    \column{0.5\textwidth}
      \hfill
      \resizebox{\columnwidth}{!}{%
        \begin{tikzpicture}[x=3.9cm,y=3.9cm]
          \fill[black!6] (0,0) rectangle (1.2,0.68);
          \draw[thick] (0,0) rectangle (1.2,0.68);
          \draw[red!70!black,line width=2.2pt]
            (0,0.24) -- (0,0.44)  (1.2,0.24) -- (1.2,0.44);
        ...
        \end{tikzpicture}}
      \begin{center}{\small Mesa vacía}\end{center}

    \column{0.5\textwidth}
      \hfill
      \includegraphics[width=\columnwidth]{entrega/1.2/circulo_mejor_caso_frame.png}
      \begin{center}{\small Círculo gigante}\end{center}
  \end{columns}
\end{frame}

\begin{frame}{Configuraciones con GA}
  \begin{columns}[T,onlytextwidth]
    \column{0.5\textwidth}
      \begin{center}
        {\small Quad}\\[0.2em]
        \includegraphics[width=\columnwidth]{entrega/1.2/quad_geometrias.png}
      \end{center}

    \column{0.5\textwidth}
      \begin{center}
        {\small Pared de círculos}\\[0.2em]
        \includegraphics[width=\columnwidth]{entrega/1.2/pared_geometrias.png}
      \end{center}
  \end{columns}
\end{frame}

\begin{frame}{GA: genes e hiperparámetros}
  \begin{itemize}\small
    \setlength{\itemsep}{0.5em}
    \item El GA modifica (genes): pos.~$(x,y)$ y radio de los obstáculos
      (quad); profundidades del perfil del muro (pared).
    \item Hiperparámetros fijos: $K$, pobl.~48, gen.~60 (quad); grano,
      perfil, pobl.~64, gen.~150 (pared).
    \item Fitness: minimizar $\tilde{t}_{90}$ (5 semillas/gen.); validación
      final con 100 corridas.
  \end{itemize}
\end{frame}
